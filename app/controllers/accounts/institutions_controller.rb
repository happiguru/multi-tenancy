module Accounts
    class InstitutionsController < Accounts::BaseController
        ...
        def new
          @institution = current_account.institutions.new
        end
        ...
        def create
          @institution = current_account.institutions.new(institution_params)
